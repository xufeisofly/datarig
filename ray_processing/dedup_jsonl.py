...
from baselines.core.file_utils import write_jsonl, read_jsonl, makedirs_if_missing, is_s3
...
def dedup_jsonl(
    ...
    if shard_files is None and is_s3(input_dir):
        input_paths = []
        s3_client = boto3.client("s3")
        ...
        for page in pages:
            try:
                ...
                exit(1)
    elif shard_files is None and not is_s3(input_dir): # xufeisofly
        input_paths = get_files_in_directory(input_dir)
    elif is_s3(input_dir):
