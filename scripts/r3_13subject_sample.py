...
finish_subject = ['sample', 'Astronomy', 'RenewableEnergy']
...
def r3_sample(subject_path, lang='en'):
    ...
    # output_folder = "oss://train1/basemodel-subjet-data-processed/hpc-processed/r3_recall_dedupe_sample"    
...
if __name__ == '__main__':
    oss_dir = "oss://train1/basemodel-subjet-data-processed/hpc-processed/r3_recall_dedupe/"
